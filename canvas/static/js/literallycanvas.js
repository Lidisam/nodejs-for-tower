...
module.exports = LiterallyCanvas = (function() {
  ...
  LiterallyCanvas.prototype.undo = function(tryx) {
    var action;
  ...
  LiterallyCanvas.prototype.redo = function(tryx) {
    var action;
...
//这里 负责引入工具
tools = {
  Pencil: _dereq_('./tools/Pencil'),//画笔
  Eraser: _dereq_('./tools/Eraser'),//橡皮擦
  Line: _dereq_('./tools/Line'),//直线
  Rectangle: _dereq_('./tools/Rectangle'),//矩形
  Ellipse: _dereq_('./tools/Ellipse'),//圆形
  Text: _dereq_('./tools/Text'),//文字
